...
//
//   let imagesSearchResponse = try? newJSONDecoder().decode(ImagesSearchResponse.self, from: jsonData)
...
struct Result: Codable {
    ...
    let currentUserCollections: [String:String?]
...
struct CoverPhoto: Codable {
    ...
    let width, height: Int
    let color: String
    let coverPhotoDescription: JSONNull?
    let altDescription: String
    let urls: Urls
    let links: ResultLinks
